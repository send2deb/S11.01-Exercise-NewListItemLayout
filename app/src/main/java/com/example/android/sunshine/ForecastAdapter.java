...
//        String weatherSummary = dateString + " - " + description + " - " + highAndLowTemperature;
        ...
        forecastAdapterViewHolder.weatherImage.setImageResource(SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId));
        forecastAdapterViewHolder.weatherDay.setText(dateString);
        forecastAdapterViewHolder.weatherDescription.setText(description);
        forecastAdapterViewHolder.weatherMaxTemp.setText(SunshineWeatherUtils.formatTemperature(mContext, highInCelsius));
        forecastAdapterViewHolder.weatherMinTemp.setText(SunshineWeatherUtils.formatTemperature(mContext, lowInCelsius));
    }
...
//          COMPLETED (6) Get references to all new views and delete this line
            ...
            weatherImage = (ImageView) view.findViewById(R.id.iv_weather_image);
